...
- **Social link list** a nice list of outbound links,
...
- Plain HTML5 + CSS3 + vanilla JavaScript no libraries and no frameworks
...
Freelance/client project its a single-page, no-dependency landing site built
